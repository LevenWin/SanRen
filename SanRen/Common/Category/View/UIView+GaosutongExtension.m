...
static char longPressActionChar;
static char longPressGestureChar;
...
@dynamic tapAction,longPressAction;
...
-(void)setLongPressAction:(void (^)(UILongPressGestureRecognizer *))longPressAction{
    self.userInteractionEnabled=YES;
    UILongPressGestureRecognizer*gesture=objc_getAssociatedObject(self, &longPressGestureChar);
    if(!gesture){
        ...
        [self addGestureRecognizer:gesture];
        objc_setAssociatedObject(self, &longPressGestureChar, gesture, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    objc_setAssociatedObject(self,&longPressActionChar,longPressAction,OBJC_ASSOCIATION_RETAIN_NONATOMIC);


}
-(void(^)(UILongPressGestureRecognizer*))longPressAction{
    void(^action)(UILongPressGestureRecognizer*)=objc_getAssociatedObject(self,&longPressActionChar);
    if(!action){
        action=nil;
        objc_setAssociatedObject(self,&longPressActionChar,action,OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return action;
}
